      ...
      <main className="pt-20">
        ...
        <section className="py-12 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            <h1 className="font-heading text-h1-mobile md:text-h1 hero-text-shadow">Terms of Service</h1>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              ...
              <h2 className="font-heading text-h3 text-foreground mt-8 mb-4">1. Acceptance of Terms</h2>
              ...
              <h2 className="font-heading text-h3 text-foreground mt-8 mb-4">2. Description of Services</h2>
              <p className="font-body text-muted-foreground mb-4 leading-relaxed">
              ...
              <h2 className="font-heading text-h3 text-foreground mt-8 mb-4">3. User Accounts</h2>
              <p className="font-body text-muted-foreground mb-4 leading-relaxed">
              ...
              <h2 className="font-heading text-h3 text-foreground mt-8 mb-4">4. Payment Terms</h2>
              <p className="font-body text-muted-foreground mb-4 leading-relaxed">
              ...
              <h2 className="font-heading text-h3 text-foreground mt-8 mb-4">5. Property Information</h2>
              <p className="font-body text-muted-foreground mb-4 leading-relaxed">
              ...
              <h2 className="font-heading text-h3 text-foreground mt-8 mb-4">6. Prohibited Conduct</h2>
              <p className="font-body text-muted-foreground mb-4 leading-relaxed">You agree not to:</p>
              <ul className="list-disc pl-6 font-body text-muted-foreground mb-4 space-y-2">
              ...
              <h2 className="font-heading text-h3 text-foreground mt-8 mb-4">7. Intellectual Property</h2>
              <p className="font-body text-muted-foreground mb-4 leading-relaxed">
              ...
              <h2 className="font-heading text-h3 text-foreground mt-8 mb-4">8. Disclaimer of Warranties</h2>
              <p className="font-body text-muted-foreground mb-4 leading-relaxed">
              ...
              <h2 className="font-heading text-h3 text-foreground mt-8 mb-4">9. Limitation of Liability</h2>
              <p className="font-body text-muted-foreground mb-4 leading-relaxed">
              ...
              <h2 className="font-heading text-h3 text-foreground mt-8 mb-4">10. Indemnification</h2>
              <p className="font-body text-muted-foreground mb-4 leading-relaxed">
              ...
              <h2 className="font-heading text-h3 text-foreground mt-8 mb-4">11. Governing Law</h2>
              <p className="font-body text-muted-foreground mb-4 leading-relaxed">
              ...
              <h2 className="font-heading text-h3 text-foreground mt-8 mb-4">12. Changes to Terms</h2>
              <p className="font-body text-muted-foreground mb-4 leading-relaxed">
              ...
              <h2 className="font-heading text-h3 text-foreground mt-8 mb-4">13. Contact Information</h2>
              <p className="font-body text-muted-foreground mb-4 leading-relaxed">
                For questions about these Terms of Service, please contact us at:
              </p>
              <div className="bg-secondary rounded-lg p-6">
                <p className="font-heading font-semibold text-foreground">Precision Capital</p>
                <p className="font-body text-muted-foreground">Ardmore, Oklahoma</p>
                <p className="font-body text-muted-foreground">Email: management@precisioncapital.homes</p>
                <p className="font-body text-muted-foreground">Phone: <a href="tel:+15803990001" className="hover:text-primary transition-colors">(580) 399-0001</a></p>
              </div>
            </div>
          </div>
        </section>
