      ...
      <main className="pt-20">
        ...
        <section className="py-12 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            <h1 className="font-heading text-h1-mobile md:text-h1 hero-text-shadow">Privacy Policy</h1>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              ...
              <h2 className="font-heading text-h3 text-foreground mt-8 mb-4">1. Introduction</h2>
              ...
              <h2 className="font-heading text-h3 text-foreground mt-8 mb-4">2. Information We Collect</h2>
              ...
              <h3 className="font-heading text-xl font-semibold text-foreground mt-6 mb-3">Automatically Collected Information</h3>
              <p className="font-body text-muted-foreground mb-4 leading-relaxed">
              ...
              <h2 className="font-heading text-h3 text-foreground mt-8 mb-4">3. How We Use Your Information</h2>
              <p className="font-body text-muted-foreground mb-4 leading-relaxed">We use the information we collect to:</p>
              <ul className="list-disc pl-6 font-body text-muted-foreground mb-4 space-y-2">
              ...
              <h2 className="font-heading text-h3 text-foreground mt-8 mb-4">4. Payment Processing</h2>
              <p className="font-body text-muted-foreground mb-4 leading-relaxed">
              ...
              <h2 className="font-heading text-h3 text-foreground mt-8 mb-4">5. Information Sharing</h2>
              <p className="font-body text-muted-foreground mb-4 leading-relaxed">
              ...
              <h2 className="font-heading text-h3 text-foreground mt-8 mb-4">6. Data Security</h2>
              <p className="font-body text-muted-foreground mb-4 leading-relaxed">
                We implement appropriate technical and organizational security measures to protect your personal information. However, no method of transmission over the Internet is 100% secure, and we cannot guarantee absolute security.
              </p>

              <h2 className="font-heading text-h3 text-foreground mt-8 mb-4">7. Cookies</h2>
              <p className="font-body text-muted-foreground mb-4 leading-relaxed">
              ...
              <h2 className="font-heading text-h3 text-foreground mt-8 mb-4">8. Your Rights</h2>
              <p className="font-body text-muted-foreground mb-4 leading-relaxed">
              ...
              <h2 className="font-heading text-h3 text-foreground mt-8 mb-4">9. Children's Privacy</h2>
              <p className="font-body text-muted-foreground mb-4 leading-relaxed">
                Our services are not directed to individuals under the age of 18. We do not knowingly collect personal information from children.
              </p>

              <h2 className="font-heading text-h3 text-foreground mt-8 mb-4">10. Changes to This Policy</h2>
              <p className="font-body text-muted-foreground mb-4 leading-relaxed">
                We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new policy on this page and updating the "Last Updated" date.
              </p>

              <h2 className="font-heading text-h3 text-foreground mt-8 mb-4">11. Contact Us</h2>
              <p className="font-body text-muted-foreground mb-4 leading-relaxed">
